	...
	<div class="main-containers">
		...
		<div class="top-container" :style='{"boxShadow":"0 0px 0px rgba(64, 158, 255, .3)","padding":"24px 12% 0","borderColor":"#eee","alignItems":"flex-start","color":"#999","textAlign":"right","display":"block","justifyContent":"flex-end","top":"0","left":"0","background":"#f5f5f5","borderWidth":"0px","width":"100%","fontSize":"16px","position":"relative","borderStyle":"solid","height":"100px","zIndex":"1002"}'>
			...
			<div :style='{"margin":"0","overflow":"hidden","top":"100px","background":"none","display":"block","width":"24%","position":"absolute","float":"left","height":"72px"}'>
			  <span :style='{"padding":"0px","overflow":"hidden","color":"#fff","alignItems":"center","background":"none","display":"flex","width":"100%","lineHeight":"32px","fontSize":"20px","float":"left","fontWeight":"500","height":"100%"}'>基于Spark的共享单车数据存储系统的设计与实现</span>
			</div>
			<!-- weather -->
			<div class="weather" :style='{"padding":"0 10px 0 0px","alignItems":"center","color":"#333","top":"16px","left":"12%","display":"flex","position":"absolute","float":"left","justifyContent":"center","fontWeight":"600"}'>
				<div :style='{"padding":"0 4px","fontSize":"inherit","lineHeight":"32px","color":"inherit"}'>{{weather.city}}</div>
				<div :style='{"padding":"0 4px","fontSize":"inherit","lineHeight":"32px","color":"inherit"}'>{{weather.tem}}°</div>
				<div :style='{"padding":"0 4px","fontSize":"inherit","lineHeight":"32px","color":"inherit"}'>{{weather.wea}}</div>
				<div :style='{"padding":"0 4px","fontSize":"inherit","lineHeight":"32px","color":"inherit"}'>{{weather.win}}</div>
				<div :style='{"padding":"0 4px","fontSize":"inherit","lineHeight":"32px","color":"inherit"}'>{{weather.win_speed}}</div>
			</div>
        ...
        <el-dialog title="投诉与建议" :visible.sync="chatFormVisible" width="600px" :before-close="chatClose">
...
export default {
    data() {
		return {
            activeIndex: '0',
			roleMenus: [{"backMenu":[{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-full","buttons":["新增","查看","修改","删除"],"menu":"用户","menuJump":"列表","tableName":"yonghu"}],"menu":"用户管理"},{"child":[{"allButtons":["新增","查看","修改","删除","便签","作者","点赞数","反对数","查看评论","首页总数","首页统计","爬取数据"],"appFrontIcon":"cuIcon-paint","buttons":["新增","查看","修改","删除","爬取数据","查看评论"],"menu":"共享单车","menuJump":"列表","tableName":"gongxiangdanche"}],"menu":"共享单车管理"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-group","buttons":["新增","查看","修改","删除"],"menu":"交流论坛","tableName":"forum"}],"menu":"交流论坛"},{"child":[{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-rank","buttons":["查看","修改"],"menu":"轮播图管理","tableName":"config"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-medal","buttons":["查看","修改"],"menu":"系统简介","tableName":"systemintro"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"通知公告","tableName":"news"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-news","buttons":["新增","查看","修改","删除"],"menu":"通知公告分类","tableName":"newstype"},{"allButtons":["新增","查看","修改","删除"],"appFrontIcon":"cuIcon-service","buttons":["新增","查看","修改","删除"],"menu":"投诉与建议","tableName":"chat"},{"allButtons":["查看","修改"],"appFrontIcon":"cuIcon-news","buttons":["查看","修改"],"menu":"关于我们","tableName":"aboutus"}],"menu":"系统管理"}],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","便签","作者","点赞数","反对数","查看评论","首页总数","首页统计","爬取数据"],"appFrontIcon":"cuIcon-present","buttons":["查看","查看评论"],"menu":"共享单车","menuJump":"列表","tableName":"gongxiangdanche"}],"menu":"共享单车模块"}],"hasBackLogin":"是","hasBackRegister":"否","hasFrontLogin":"否","hasFrontRegister":"否","roleName":"管理员","tableName":"users"},{"backMenu":[],"frontMenu":[{"child":[{"allButtons":["新增","查看","修改","删除","便签","作者","点赞数","反对数","查看评论","首页总数","首页统计","爬取数据"],"appFrontIcon":"cuIcon-present","buttons":["查看","查看评论"],"menu":"共享单车","menuJump":"列表","tableName":"gongxiangdanche"}],"menu":"共享单车模块"}],"hasBackLogin":"否","hasBackRegister":"否","hasFrontLogin":"是","hasFrontRegister":"是","roleName":"用户","tableName":"yonghu"}],
			baseUrl: '',
			carouselList: [],
			menuList: [],
