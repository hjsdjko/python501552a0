<template>
	<div class="navbar">
		...
		<!-- 天气 -->
		<div class="weather" :style='{"padding":"0 0px","margin":"0 20px 0 0","alignItems":"center","color":"#fff","flexWrap":"wrap","background":"url() no-repeat right center","display":"flex","width":"150px","justifyContent":"center","order":"1"}'>
		  <div :style='{"width":"50%","padding":"0 4px","fontSize":"inherit","lineHeight":"1.5","color":"inherit","textAlign":"right"}'>{{weather.city}}</div>
		  <div :style='{"width":"50%","padding":"0 4px","fontSize":"inherit","lineHeight":"1.5","color":"inherit"}'>{{weather.tem}}°</div>
		  <div :style='{"padding":"0 4px","fontSize":"inherit","lineHeight":"1.5","color":"inherit"}'>{{weather.wea}}</div>
		  <div :style='{"padding":"0 4px","fontSize":"inherit","lineHeight":"1.5","color":"inherit"}'>{{weather.win}}</div>
		  <div :style='{"padding":"0 4px","fontSize":"inherit","lineHeight":"1.5","color":"inherit"}'>{{weather.win_speed}}</div>
		</div>
		<!--
