<template>
	<div class="content" :style='{"alignContent":"flex-start","minHeight":"100vh","overflow":"hidden","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/a8c4412078c84883902ad3bedef73407.jpg) no-repeat center top / 100% 100%","display":"flex","width":"100%","position":"relative","height":"100vh"}'>
		<div :style='{"width":"100%","margin":"0","position":"relative"}'>
			<!-- 标题 -->
			<div :style='{"margin":"0 0 0 0","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20231125/75410a39437645089c0b08ff4e957075.gif) no-repeat center top","width":"100%","lineHeight":"80px","fontSize":"28px","height":"95px"}'>欢迎使用 {{this.$project.projectName}}</div>
			<!-- 时间 -->
			<div :style='{"top":"0","color":"#fff","display":"inline-block","lineHeight":"54px","fontSize":"16px","position":"absolute","right":"30px","height":"64px"}'>{{ dates }}</div>
		</div>
		<div :style='{"padding":"20px 20px 0","display":"flex","height":"calc(100vh - 95px)"}'>
			<div :style='{"width":"30%","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts1">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"40px"}'>
						<div :style='{"color":"#fff","fontSize":"16px"}'>
							便签
						</div>
					</div>
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="gongxiangdancheChart1" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts2">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"40px"}'>
					...
					<div :style='{"width":"100%","height":"85%"}'>
						<div id="gongxiangdancheChart2" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
			<div :style='{"width":"40%","padding":"0 20px","flexWrap":"wrap","display":"flex"}'>
				<div v-if="systemIntroductionDetail" :style='{"padding":"20px","margin":"0 0 20px","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/26d4501d35db46278b1d99be2f14602f.png) no-repeat center top / 100% 100%","display":"flex","width":"100%","height":"calc(30% - 20px)"}'>
					<el-carousel :style='{"width":"50%","margin":"0 auto"}' trigger="click" indicator-position="inside" arrow="always" type="default" direction="horizontal" height="160px" :autoplay="false" :interval="3000" :loop="true">
				...
				<!-- 统计 -->
				<div :style='{"alignContent":"center","padding":"10px","margin":"0 0 20px 0","color":"#fff","alignItems":"center","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231125/26d4501d35db46278b1d99be2f14602f.png) no-repeat center top / 100% 100%","display":"flex","width":"100%","fontSize":"14px","height":"calc(30% - 20px)","order":"2"}'>
					...
					<div :style='{"width":"100%","alignItems":"center","background":"rgba(255,255,255,0)","justifyContent":"center","display":"flex"}'>
						...
						<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
							<div :style='{"lineHeight":"32px","fontSize":"inherit","color":"inherit","height":"32px"}'>共享单车总数</div>
							<div :style='{"lineHeight":"32px","fontSize":"16px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{gongxiangdancheCount}}</div>
						</div>
					</div>
				</div>
				<div class="tables">
					<div :style='{"margin":"0 0 0px 0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,0)","width":"100%","lineHeight":"40px","fontSize":"14px","height":"40px"}'>共享单车</div>
					<el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#5c89e6","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
						<el-table-column :resizable="true" :sortable="false" prop="biaoti" label="标题"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="fengmian" label="封面">
							<template slot-scope="scope">
								<div v-if="scope.row.fengmian">
									<img v-if="scope.row.fengmian.substring(0,4)=='http'" :src="scope.row.fengmian.split(',')[0]" width="30" height="30">
									<img v-else :src="$base.url+scope.row.fengmian.split(',')[0]" width="30" height="30">
								</div>
								<div v-else>无图片</div>
							</template>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="zuozhe" label="作者"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="liulanliang" label="浏览量"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="fanduishu" label="反对数"/>
						</el-table-column>
						<el-table-column :resizable="true" :sortable="false" prop="dianzanshu" label="点赞数"/>
						</el-table-column>
					</el-table>
				</div>
			</div>
			<div :style='{"width":"30%","flexWrap":"wrap","display":"flex"}'>
				<div class="echarts3">
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="gongxiangdancheChart3" style="width:100%;height:100%;"></div>
					</div>
				</div>
				<div class="echarts4">
					<div :style='{"width":"100%","alignItems":"flex-end","textAlign":"center","justifyContent":"center","display":"flex","height":"40px"}'>
					...
					<div :style='{"width":"100%","height":"calc(100% - 40px)"}'>
						<div id="gongxiangdancheChart4" style="width:100%;height:100%;"></div>
					</div>
				</div>
			</div>
		</div>
...
export default {
	data() {
		return {
			...
			map: {"tooltip":{"formatter":"{b} : {c}","trigger":"item"},"backgroundColor":"transparent","title":{"borderType":"solid","padding":10,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"shadowBlur":0,"bottom":"auto","show":true,"right":"auto","top":"auto","borderRadius":0,"left":"left","borderWidth":0,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","fontSize":14,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"#ccc","textShadowBlur":0},"shadowColor":"transparent"},"legend":{"padding":5,"itemGap":10,"shadowOffsetX":0,"backgroundColor":"transparent","borderColor":"#ccc","shadowOffsetY":0,"orient":"horizontal","shadowBlur":0,"bottom":"auto","itemHeight":14,"show":false,"icon":"roundRect","itemStyle":{"borderType":"solid","shadowOffsetX":0,"borderColor":"inherit","shadowOffsetY":0,"color":"inherit","shadowBlur":0,"borderWidth":0,"opacity":1,"shadowColor":"transparent"},"right":"auto","top":"auto","borderRadius":0,"lineStyle":{"shadowOffsetX":0,"shadowOffsetY":0,"color":"inherit","shadowBlur":0,"width":"auto","type":"inherit","opacity":1,"shadowColor":"transparent"},"left":"right","borderWidth":0,"width":"auto","itemWidth":25,"textStyle":{"textBorderWidth":0,"color":"#fff","textShadowColor":"transparent","ellipsis":"...","overflow":"none","fontSize":12,"lineHeight":24,"textShadowOffsetX":0,"textShadowOffsetY":0,"textBorderType":"solid","fontWeight":500,"textBorderColor":"transparent","textShadowBlur":0},"shadowColor":"rgba(0,0,0,.3)","height":"auto"},"series":{"zoom":1.2,"label":{"emphasis":{"show":true,"textStyle":{"color":"#fac859"}},"normal":{"color":"#fac859","show":true}},"roam":true,"aspectScale":0.75,"showLegendSymbol":false,"animation":false},"visualMap":{"min":0,"text":["High","Low"],"inRange":{"color":["#00467F","#A5CC82"]},"max":100,"calculable":true,"seriesIndex":[0]}},
...
<style lang="scss" scoped>
	.tables {
				...
				margin: 0 0 20px;
				background: url(http://codegen.caihongy.cn/20231125/26d4501d35db46278b1d99be2f14602f.png) no-repeat center top / 100% 100%;
				width: 100%;
				overflow-y: scroll;
				transition: 0.3s;
				height: calc(36% - 20px);
