...
<div class="content" :style='{"padding":"20px 30px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231003/cc88bae96def417689c07dc1358d4a32.png) no-repeat center top / cover","display":"flex","fontSize":"14px","height":"100%"}'>
	...
	<div :style='{"border":"0px solid rgba(126, 96, 16, .1)","padding":"0px 0","margin":"0 0px 20px 0px","alignItems":"center","color":"#62779c","flexWrap":"wrap","background":"none","display":"flex","width":"100%","fontSize":"14px","order":"0"}'>
		<div :style='{"boxShadow":"0 0px 0px rgba(0,0,0,.3)","padding":"12px 0","margin":"0 2% 20px 0","borderColor":"rgba(126, 96, 16, .1)","alignItems":"center","textAlign":"left","flexDirection":"row-reverse","display":"flex","borderRadius":"8px","background":"url(http://codegen.caihongy.cn/20231003/b8ae010ba2ff44268dee3545917b55dd.png) no-repeat right bottom / 80% 80%,#fff","borderWidth":"0 0 0px","width":"18%","borderStyle":"solid"}' v-if="isAuth('gongxiangdanche','首页总数')">
			...
			<div :style='{"width":"auto","flexDirection":"column","justifyContent":"center","display":"flex"}'>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"34px","color":"inherit","fontWeight":"bold","height":"24px"}'>{{gongxiangdancheCount}}</div>
				<div :style='{"margin":"5px 0","lineHeight":"24px","fontSize":"inherit","color":"inherit","height":"24px"}'>共享单车总数</div>
			</div>
		</div>
	</div>
	<!-- statis -->
	...
	<!-- 日历 -->
	<div class="calendar" :style='{"border":"0px solid #eee","boxShadow":"0 0px 0px rgba(0,0,0,.1)","margin":"0px auto 20px","borderRadius":"0px","color":"#666","background":"none","width":"calc(100% - 0px)","fontSize":"inherit","height":"auto","order":"1"}'>
	  <div :style='{"padding":"10px 10px","borderColor":"rgba(126, 96, 16, .1)","color":"#fff","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20231004/9593cdaca78544cb84c28c375aa4c54a.png) no-repeat center top / 100% 100%,#62779c","borderWidth":"0 0 0px","display":"flex","width":"100%","borderStyle":"solid","justifyContent":"space-around","height":"auto"}'>
	  ...
	  <table :style='{"border":"0px solid #eee","width":"100%","padding":"0 0 20px","borderRadius":"0px","background":"rgba(255, 255, 255, .96)","height":"auto"}' v-if="this.weeks.length">
	    <thead :style='{"width":"100%","height":"auto"}'>
	      <tr :style='{"width":"100%","alignItems":"center","justifyContent":"center","display":"flex"}'>
	        <th :style='{"alignItems":"center","color":"inherit","flex":1,"display":"flex","lineHeight":"24px","fontSize":"inherit","justifyContent":"center"}' v-for="item,index in this.heads" :key="index">{{item}}</th>
	      </tr>
	    </thead>
	    <tbody :style='{"width":"100%"}'>
	      <tr :style='{"width":"100%","alignItems":"center","justifyContent":"center","display":"flex"}' v-for="week,index in this.weeks" :key="index">
	        <td :style='{"cursor":"pointer","padding":"6px 12px 6px","flex":1,"display":"flex","height":"auto"}' v-for="day,key in week.days" :key="key" :class="{other: day.isOther, festival: day.isFestival, today: day.isToday, rest: day.isRest}">
	          <div class="text">
	...
	<div class="type4" :style='{"alignContent":"flex-start","padding":"0","borderRadius":"8px","flexWrap":"wrap","background":"none","flex":"1","display":"flex","width":"100%","position":"relative","justifyContent":"space-between","height":"auto","order":"10"}'>
		<div id="gongxiangdancheChart1" class="echarts1" v-if="isAuth('gongxiangdanche','首页统计')"></div>
		<div id="gongxiangdancheChart2" class="echarts2" v-if="isAuth('gongxiangdanche','首页统计')"></div>
		<div id="gongxiangdancheChart3" class="echarts3" v-if="isAuth('gongxiangdanche','首页统计')"></div>
		<div id="gongxiangdancheChart4" class="echarts4" v-if="isAuth('gongxiangdanche','首页统计')"></div>
	</div>
</div>
</template>
<script>
...
<style lang="scss" scoped>
	...
	.calendar td.festival .text {
				...
				border-radius: 0px;
				flex-direction: column;
				color: rgba(98, 119, 156, 1);
				background: rgba(98, 119, 156, .03);
				display: flex;
				width: 100%;
				justify-content: center;
				align-items: center;
