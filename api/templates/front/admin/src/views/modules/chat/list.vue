        ...
        >
          ...
          >
            <template slot-scope="scope">
              <el-button
                type="text"
				:style='{"border":"1px solid #1b2b4a","cursor":"pointer","padding":"0 12px 0 6px","margin":"0 10px 5px 0","outline":"none","color":"#1b2b4a","borderRadius":"0px","background":"none","width":"auto","fontSize":"14px","height":"26px"}'
                size="small"
